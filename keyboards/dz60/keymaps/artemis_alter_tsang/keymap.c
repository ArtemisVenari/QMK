...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[BASE] = LAYOUT_60_tsangan(
		...
		KC_LSFT,          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,          KC_RSFT, TG(SUPER),
		KC_LCTL, XXXXXXX, KC_LALT,                             KC_SPC,                                                KC_RALT, XXXXXXX, TG(SHIFT)
	),
    [SHIFT] = LAYOUT_60_tsangan(
		KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,         KC_DEL,
		_______,          KC_Q, KC_UP,   KC_ENT, KC_PGUP, XXXXXXX, XXXXXXX, XXXXXXX, KC_VOLU, KC_MPLY, XXXXXXX, XXXXXXX, XXXXXXX,      RGB_TOG,
		_______,          KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, XXXXXXX, XXXXXXX, KC_MPRV, KC_VOLD, KC_MNXT,  XXXXXXX, XXXXXXX,       _______,
	...
	[SUPER] = LAYOUT_60_tsangan(
		KC_TILDE, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,         _______,
